...
describe('Create Event', () => {
    ...
    it('Should create a new event successfully!', async () => {
        ...
        const saveSpy = jest
            ...
            .mockResolvedValueOnce(mockEventDocument);
...
describe('Delete Event by ID', () => {
    ...
    it('Should delete a specific event successfully!', async () => {
        ...
        const deleteSpy = jest
            .spyOn(EventModel, 'findOneAndDelete')
    ...
    it('Should handle errors during event deletion by ID', async () => {
        ...
        await expect(
            deleteEventById(mockRequest, mockResponse),
        ).rejects.toThrow();
...
describe('Delete Events by Day', () => {
    ...
    it('Should delete events for a specific day successfully!', async () => {
        ...
        const deleteManySpy = jest
            .spyOn(EventModel, 'deleteMany')
            .mockResolvedValueOnce(deletedEvents);
    ...
    it('Should handle errors during event deletion by day', async () => {
        ...
        await expect(
            deleteEventsByDay(mockRequest, mockResponse),
        ).rejects.toThrow();
