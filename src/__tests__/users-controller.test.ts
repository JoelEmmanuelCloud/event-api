...
describe("Sign Up User", () => {
  ...
  it("Should sign up a new user successfully!", async () => {
    ...
    const saveSpy = jest.spyOn(UserModel.prototype, "save").mockResolvedValueOnce(mockUserDocument);
  ...
  it("Should handle errors during user signup", async () => {
    ...
    const findOneSpy = jest.spyOn(UserModel, "findOne").mockRejectedValueOnce(new Error("Database error"));
